...
def home():
    ...
    origami = Post.query.order_by(Post.date_posted.desc()).paginate(page=page, per_page=5)
...
def register():
    ...
    if form.validate_on_submit():
        ...
        db.session.add(user)
        db.session.commit()
        flash(f'Your account has been created and now you can login','success')
...
def user_posts(username):
    ...
    origami = Post.query.filter_by(author=user)\
...
def send_reset_email(user):
    ...
    msg = Message('Password Reset From Origami', sender='jeffery1996.jbw@gmail.com', recipients=[user.email])
